...
The data for this assignment are available from the following web site as a single zip file:
...
## Objective
The overall goal of this assignment is to explore the National Emissions Inventory database and see what it say about fine particulate matter pollution in the United states over the 10-year period 1999–2008. We have mainly used the 'ggplot2' package of R, although the base plot has also been used at some places

## Questions

Our Exploratory Data Analysis addresses the following questions and tasks. For each question/task we have made a single plot. 
...
## Files
There are 6 plots and 6 .R files corresponding to each of the questions above. All the files will individually download the data, when run. However, that might be a little lengthy process.  Hence, it is advised to directly download the file and read using the readRDS() function manually.
